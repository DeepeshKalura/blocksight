...
export function CTASection() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
      <div className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-linear-to-br from-accent via-accent/90 to-accent/70 p-8 sm:p-10 md:p-12 lg:p-16">
        {/* Pattern overlay */}
        ...
        <div className="relative text-center space-y-5 sm:space-y-6 md:space-y-8 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-md mx-auto">
            ...
            />
            <Button size="lg" className="bg-white text-accent hover:bg-white/90 gap-2 shrink-0 h-10 sm:h-11 text-sm sm:text-base">
              Get Started
