  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-12 sm:py-16 md:py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-2xl sm:text-3xl md:text-4xl mb-3 sm:mb-4 text-foreground max-w-4xl">
          How It Works
        </h2>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-accent border-2 border-accent shadow-lg shadow-accent/50" />
              </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-accent via-accent/70 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
