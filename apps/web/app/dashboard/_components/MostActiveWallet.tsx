          ...
          <TableBody>
            {wallets.map((wallet, index) => (
              <TableRow key={wallet.address}>
                ...
                <TableCell>
                  <span className="text-muted-foreground">{wallet.averageTransactionSize} ETH</span>
                </TableCell>
                <TableCell>
                  <div className="flex gap-2 text-xs">
                    <span className="text-accent">↓{wallet.incomingCount}</span>
                    <span className="text-destructive">↑{wallet.outgoingCount}</span>
                  </div>
                </TableCell>
              </TableRow>
            ))}
